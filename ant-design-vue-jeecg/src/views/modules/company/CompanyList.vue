<template>
  <a-card :bordered="false">
        ...
        <a-row :gutter="24">
          ...
          <a-col :md="6" :sm="8">
            <a-form-item label="中文名">
              <a-input placeholder="请输入中文名" v-model="queryParam.zhName"></a-input>
            </a-form-item>
          </a-col>
          <a-col :md="6" :sm="8">
            <a-form-item label="英文名">
              <a-input placeholder="请输入英文名" v-model="queryParam.enName"></a-input>
            </a-form-item>
          </a-col>
        ...
        <a-col :md="6" :sm="8">
          ...
          <a-col :md="6" :sm="8">
            <a-form-item label="公司邮箱">
              <a-input placeholder="请输入公司邮箱" v-model="queryParam.email"></a-input>
            </a-form-item>
          </a-col>
          </template>
          <a-col :md="6" :sm="8" >
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('公司信息')">导出</a-button>
